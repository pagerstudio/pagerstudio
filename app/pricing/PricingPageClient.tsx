  ...
  return (
    <main>
      ...
      <section className="section section-white px-6 md:px-10" style={{ paddingBottom: 'clamp(72px, 10vw, 100px)' }}>
        <div className="bg-ps-black texture-lines texture-shimmer rounded-[20px] sm:rounded-[28px] max-w-[1200px] mx-auto px-5 sm:px-6 md:px-[60px] py-[40px] sm:py-[60px] md:py-[100px] text-center">
