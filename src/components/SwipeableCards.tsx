    ...
    >
      <div className="flex flex-col min-w-0 text-left">
        ...
        <div className="flex items-center justify-between mt-4 md:mt-6 pt-4 md:pt-6">
          <Link
            href={`/blog/${post.slug}`}
            className="group relative inline-flex items-center gap-1 text-micro md:text-footnote text-text-inverse-secondary hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded"
          >
            Read full blog
