  ...
  return (
    <div className="w-full rounded-2xl border border-border-subtle p-6 md:p-8 text-center">
      ...
      <div className="mt-4 flex justify-center">
        <button
          onClick={handleClick}
          className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full bg-white text-black text-sm font-semibold shadow-sm hover:shadow-md transition-all border border-gray-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
        >
