    ...
    <section className="section section-white" aria-label="Industry Data">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <TiltCard className="bg-white rounded-[24px] border border-[#E5E5E5] p-5 sm:p-6 flex flex-col min-h-0 sm:min-h-[280px] relative" delay={0}>
          ...
          <TiltCard className="bg-white rounded-[24px] border border-[#E5E5E5] p-5 sm:p-6 flex flex-col items-center justify-center min-h-0 sm:min-h-[260px] relative" delay={0.1}>
              ...
              <div className="relative hidden md:block" style={{ height: '200px' }}>
                ...
                <div className="absolute bottom-0 left-4 right-4 flex items-end justify-center gap-6">
                  {[
                    ...
                    { label: 'Google', value: '34%', h: 178, highlight: false },
                    { label: 'Doctor', value: '32%', h: 168, highlight: false },
                  ].map((item) => (
          ...
          <TiltCard className="bg-white rounded-[24px] border border-[#E5E5E5] p-5 sm:p-6 flex flex-col min-h-0 sm:min-h-[300px] relative" delay={0.3}>
